...
// model.addAttribute("borrowByMonth",
// borrowService.getBorrowCountByMonth(2026));
...
// public String updateUser(@PathVariable Long id, @ModelAttribute UserDTO
// userDTO) {
...
// // Search/filter trạng thái/ngày hiện xử lý phía frontend bằng
// librarian-loans.js.
// @GetMapping("/loans")
// public String loans(
// @RequestParam(required = false) String keyword,
...
// // UI librarian/reservations cần xem cả PENDING, FULFILLED, CANCELLED,
// NOTIFIED.
...
// // UI librarian/reports cần dữ liệu tổng hợp riêng, không dùng chung model
// dashboard.
// @GetMapping("/reports")
