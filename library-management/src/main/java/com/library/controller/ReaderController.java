...
// // Trang chủ reader
// @GetMapping("/home")
// public String home(@AuthenticationPrincipal UserDetails userDetails, Model
// model) {
// Long userId = getUserId(userDetails);
// model.addAttribute("recommendations",
// recommendService.recommendBooks(userId));
// model.addAttribute("featuredBooks", recommendService.recommendBooks(userId));
// // dùng AI làm featured
